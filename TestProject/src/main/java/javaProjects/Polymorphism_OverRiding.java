...
abstract class Polymorphism_OverRiding {
	...
	Polymorphism_OverRiding(String name) {
...
class Rectangle extends Polymorphism_OverRiding {
...
//Class 3
//Helper class extending Class 1
class Circle extends Polymorphism_OverRiding {
...
class GFG {
	...
	public static void main(String[] args) {
		...
		Polymorphism_OverRiding rect = new Rectangle(2, 3, "Rectangle");
		...
		Polymorphism_OverRiding circle = new Circle(2, "Circle");
